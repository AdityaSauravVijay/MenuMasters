...
export const getRecipeList = async (setnewRecipes) => {
  const resp = await fetch(`recipe/list`);
  if (resp.ok) {
...
export const getFavRecipesAsync = createAsyncThunk(
  ...
  async () => {
    const resp = await fetch("fav_recipe/list");
    if (resp.ok) {
      const recipes = await resp.json();
      return recipes;
    }
...
export const recipeComment = async (postId, comment, usrId, setComment) => {
  ...
  const res = await fetch(`recipe/${postId}/comment`, {
    method: "POST",
    headers: {
...
export const recipeDeleteAsync= createAsyncThunk(
	...
	async (payload) => {
		...
		const resp = await fetch(`recipe/delete/${payload.postId}`, {
			method: 'POST',
			headers: {
			'Content-Type': 'application/json',
			},
...
export const addFavRecipeAsync = createAsyncThunk(
  ...
  async (payload) => {
    ...
    const resp = await fetch(`fav_recipe/add_recipe`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
...
export const removeFavRecipeAsync = createAsyncThunk(
  ...
  async (payload) => {
    ...
    const resp = await fetch(`fav_recipe/remove_recipe`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
      },
